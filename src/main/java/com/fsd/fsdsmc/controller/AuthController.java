package com.fsd.sbauser.controller;
...
import com.fsd.sbauser.constant.Const;
import com.fsd.sbauser.filters.FsdUserDetailsService;
import com.fsd.sbauser.model.AuthRequest;
import com.fsd.sbauser.model.AuthResponse;
import com.fsd.sbauser.service.UsersService;
import com.fsd.sbauser.utils.CommonResult;
import com.fsd.sbauser.utils.JwtTokenUtil;
import com.fsd.sbauser.utils.ResponseBean;
...
@CrossOrigin
@RestController
//@RequestMapping(value = "api/fsd/secure", produces = MediaType.APPLICATION_JSON_VALUE) // 可访问api/fsd/secure/login
